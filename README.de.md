...
Das Projekt befindet sich derzeit noch in der Machbarkeitsprüfung (_psst … es sieht gut aus soweit_), in der wir prüfen, ob das was wir vorhaben überhaupt sinnvoll möglich ist. Das nächste Ziel ist ein MVP ([minimum viable product](https://de.wikipedia.org/wiki/Minimum_Viable_Product)), den man schon nutzen kann um einfache Programmieraufgaben in der Programmiersprache Python stellen zu können.
...
Wäre es nicht schöner, wenn man dort weiter machen könnte wo man aufgehört hat? Mit Scratch oder der Schildkröte, die Linien zeichnen konnte hattest du doch schon so etwas wie ein Spiel, dass du mit deinem Programm steuern konntest. Könnte man das nicht einfach auf das nächste Level heben? Aber wie?
...
- _Zugänglichkeit_ - Es soll immer einfach sein "einfach drauflos zu coden". Keine unnötig komplizierten Installationsprozeduren, Build-Scripte, Systemabhängigkeiten, Paketmanager, …
...
- _Robustheit_ - Die Engine muss mit User-Code umgehen können, der nicht _ganz so optimal wie möglich_ ist. Es ist unsere Aufgabe dafür zu sorgen, dass dann nicht alles außer Kontrolle gerät.
...
Das ist das Hauptproblem, dass alle nicht-kommerziellen Projekte plagt: Genug Freiwillige mit den richtigen Fertigkeiten finden, die genug Zeit haben gemeinsam an etwas zu arbeiten. Dieses Projekt dient in erster Linie Lehrzwecken und es ist daher nicht damit zu rechnen, dass sich jemand findet, der die investierte Zeit vergütet.

### Sprachbarriere

Momentan befindet sich unser kleines Team fast vollständig in Deutschland. Englisch als Hauptkommunikationssprache ist hierzulande nicht so üblich wie in kleineren Ländern. Wir versuchen die wichtigsten Einstiegsdokumente und -aufgaben zu lokalisieren.
...
- [Lua](https://www.lua.org/) - sehr einfach Script-Sprache; wird von einigen bekannten Spielen unterstützt
...
Wir verwenden das kollektive _Du_ als Anrede in den Dokumenten, da dies im modernen IT-Umfeld üblich ist. Bitte respektiere bei der direkten Kommunikation dennoch die vom Gesprächspartner (z.B. Lehrer) gewählte Anrede.

Dieses Projekt richtet sich an Personen, die sich für IT interessieren. In diesem Fachbereich hat sich Amerikanisches Englisch als Sprache der internationalen Zusammenarbeit durchgesetzt. Aus diesem Grund werden auch in den Deutschen Dokumenten Englische Begriffe und Anglizismen genutzt, sofern diese etabliert sind.
